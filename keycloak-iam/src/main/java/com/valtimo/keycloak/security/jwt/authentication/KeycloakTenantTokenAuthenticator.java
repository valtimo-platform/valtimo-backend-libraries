...
public class KeycloakTenantTokenAuthenticator extends TokenAuthenticator {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KeycloakTenantTokenAuthenticator.class);
    public final static String REALM_ACCESS = "realm_access";
    public final static String RESOURCE_ACCESS = "resource_access";
    private final String clientName;

    public KeycloakTenantTokenAuthenticator(String keycloakClient) {
