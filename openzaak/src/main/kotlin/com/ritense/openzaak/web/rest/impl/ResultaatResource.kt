...
import com.ritense.openzaak.web.rest.ResultaatResource
import com.ritense.openzaak.web.rest.request.ZaakTypeRequest
import org.springframework.http.ResponseEntity

class ResultaatResource(
    private val zaakResultaatService: ZaakResultaatService
) : ResultaatResource {

    override fun getResultaatTypes(zaakTypeRequest: ZaakTypeRequest): ResponseEntity<List<ResultaatType>> {
        return ResponseEntity.ok(zaakResultaatService.getResultaatTypes(zaakTypeRequest.zaaktype).results.toList())
    }
}