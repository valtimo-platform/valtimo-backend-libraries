...
@Embeddable
public class OperatonProcessDefinitionId implements ProcessDefinitionKey, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperatonProcessDefinitionId that)) {
            return false;
        }
