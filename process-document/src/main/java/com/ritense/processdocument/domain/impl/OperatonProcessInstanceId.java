...
@Embeddable
public class OperatonProcessInstanceId implements ProcessInstanceId, Serializable {

    @Column(name = "camunda_process_instance_id", columnDefinition = "VARCHAR(64)")
    private String id;

    public OperatonProcessInstanceId(final String id) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperatonProcessInstanceId)) {
            return false;
        }
        OperatonProcessInstanceId that = (OperatonProcessInstanceId) o;
