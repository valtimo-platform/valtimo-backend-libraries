...
public class OperatonProcessJsonSchemaDocumentInstance
    implements ProcessDocumentInstance, Persistable<OperatonProcessJsonSchemaDocumentInstanceId> {

    @EmbeddedId
    private OperatonProcessJsonSchemaDocumentInstanceId processDocumentInstanceId;
    ...
    OperatonProcessJsonSchemaDocumentInstance() {
    }

    @Override
    public OperatonProcessJsonSchemaDocumentInstanceId processDocumentInstanceId() {
    ...
    @Override
    @JsonIgnore
    public OperatonProcessJsonSchemaDocumentInstanceId getId() {
        return processDocumentInstanceId;
    }
