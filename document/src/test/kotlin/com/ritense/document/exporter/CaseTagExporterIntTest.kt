...
class CaseTagExporterIntTest @Autowired constructor(
    private val objectMapper: ObjectMapper,
    private val resourceLoader: ResourceLoader,
    private val exporter: CaseTagExporter
) : BaseIntegrationTest() {

    @Test
    fun `should export tags for case definition`(): Unit = runWithoutAuthorization {
