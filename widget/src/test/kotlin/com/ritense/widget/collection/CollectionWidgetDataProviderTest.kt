...
class CollectionWidgetDataProviderTest(
    @Mock private val valueResolverService: ValueResolverService
) {

    private val widgetDataProvider = CollectionWidgetDataProvider(MapperSingleton.get(), valueResolverService)
    ...
    fun `should resolve data when JsonNode collection is resolved`() {
        ...
        val page = widgetDataProvider.getData(widget, properties)
    ...
    private fun testWidget() = CollectionWidget(
    ...
    private fun mockCollection(widget: CollectionWidget, collectionValue: Any?) {
