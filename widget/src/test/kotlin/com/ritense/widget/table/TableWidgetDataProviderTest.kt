...
class TableWidgetDataProviderTest(
    @Mock private val valueResolverService: ValueResolverService
) {

    private val widgetDataProvider = TableWidgetDataProvider(MapperSingleton.get(), valueResolverService)
    ...
    private fun testWidget() = TableWidget(
    ...
    private fun mockCollection(widget: TableWidget, collectionValue: Any?) {
        whenever(
