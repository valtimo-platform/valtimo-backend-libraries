...
import static com.ritense.valtimo.contract.authentication.AuthoritiesConstants.*;
import static org.springframework.http.HttpMethod.*;
import static org.springframework.http.HttpStatus.*;

class FormViewModelSecurityResourceTest extends SecuritySpecificEndpointIntegrationTest {
    ...
    void getMilestoneSetAsAdmin() throws Exception {
        assertHttpStatus(GET, "/api/v1/form/view-model?formId=formId&taskInstanceId=taskInstanceId", OK);
    }
