...
class CaseTaskListExporterIntTest @Autowired constructor(
    private val objectMapper: ObjectMapper,
    private val resourceLoader: ResourceLoader,
    private val caseTaskListExporter: CaseTaskListExporter
) : BaseIntegrationTest() {
    ...
    fun `should export tabs for case definition`(): Unit = runWithoutAuthorization {
        ...
        val caseTaskListExport = exportResult.exportFiles.singleOrNull {
            it.path == path
        }
