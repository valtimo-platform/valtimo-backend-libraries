...
public class OperatonCollectionHelper {
    ...
    public void updateListElement(VariableScope variableScope, String collectionKey, String elementKey) {
        ...
        Objects.requireNonNull(loopCounter, "operaton loopcounter was not found in process variables. this is only available in a multi instance element");
