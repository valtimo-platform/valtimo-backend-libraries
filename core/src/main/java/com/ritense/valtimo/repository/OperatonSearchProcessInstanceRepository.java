...
import com.ritense.valtimo.helper.OperatonOrderByHelper;
...
public class OperatonSearchProcessInstanceRepository {

    private final SqlSession session;
    private static final String SEARCH_INSTANCE_COUNT_STATEMENT = "com.ritense.valtimo.operaton.processinstance.searchInstancesCount";
    private static final String SEARCH_INSTANCES_STATEMENT = "com.ritense.valtimo.operaton.processinstance.searchInstances";

    public OperatonSearchProcessInstanceRepository(SqlSession session) {
    ...
    public Page<ProcessInstance> searchInstances(String processDefinitionName, ProcessInstanceSearchDTO processInstanceSearchDTO, Pageable pageable) {
        ...
        query.setOrderingProperties(OperatonOrderByHelper.sortToOrders("HistoricProcessInstance", pageable.getSort()));
