...
public class InstanceCountChart {
    ...
    public InstanceCountChart(List<OperatonProcessDefinition> processDefinitions, List<InstanceCount> processInstances) {
        ...
        for (int i = 0; i <= 14; ++i) {
            ...
            for (OperatonProcessDefinition processDefinition : processDefinitions) {
