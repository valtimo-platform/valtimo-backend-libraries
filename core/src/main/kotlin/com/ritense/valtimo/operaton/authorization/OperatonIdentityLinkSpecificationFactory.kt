...
class OperatonIdentityLinkSpecificationFactory(
    private val operatonRuntimeService: OperatonRuntimeService,
    private var queryDialectHelper: QueryDialectHelper
) : AuthorizationSpecificationFactory<OperatonIdentityLink> {

    override fun create(
        request: AuthorizationRequest<OperatonIdentityLink>,
        permissions: List<Permission>
    ): AuthorizationSpecification<OperatonIdentityLink> {
        return OperatonIdentityLinkSpecification(
            request,
            permissions,
    ...
    override fun canCreate(request: AuthorizationRequest<*>, permissions: List<Permission>): Boolean {
        return OperatonIdentityLink::class.java == request.resourceType
    }
}