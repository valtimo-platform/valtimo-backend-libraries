...
class OperatonVariableInstance(
    ...
    val byteArrayValue: OperatonBytearray?,
    ...
    fun getTypedValue(deserializeValue: Boolean): TypedValue? {
        return OperatonContextService.runWithCommandContext {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is OperatonVariableInstance) return false
