...
class OperatonTask(
    ...
    val processInstance: OperatonExecution?,
    ...
    val identityLinks: List<OperatonIdentityLink> = emptyList(),
    ...
    @Transient
    override fun getParentVariableScope(): OperatonVariableScope? = parentTask?:execution
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is OperatonTask) return false
