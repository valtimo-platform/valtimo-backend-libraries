...
class OperatonIdentityLinkSpecification(
    authRequest: AuthorizationRequest<OperatonIdentityLink>,
    permissions: List<Permission>,
    private val operatonRuntimeService: OperatonRuntimeService,
    private val queryDialectHelper: QueryDialectHelper
) : AuthorizationSpecification<OperatonIdentityLink>(authRequest, permissions) {

    override fun toPredicate(
        root: Root<OperatonIdentityLink>,
        query: AbstractQuery<*>,
    ...
    override fun identifierToEntity(identifier: String): OperatonIdentityLink {
        return runWithoutAuthorization {
            operatonRuntimeService.getIdentityLink(identifier)
