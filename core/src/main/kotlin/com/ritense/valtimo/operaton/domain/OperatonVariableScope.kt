...
abstract class OperatonVariableScope : VariableScope {

    protected abstract fun getVariableInstancesLocal() : Collection<OperatonVariableInstance>

    protected abstract fun getParentVariableScope() : OperatonVariableScope?

    override fun getVariables(): Map<String, Any?> = variablesTyped

    override fun getVariablesTyped(): OperatonVariableMap = getVariablesTyped(true)

    override fun getVariablesTyped(deserializeValues: Boolean): OperatonVariableMap {
        ...
        return OperatonVariableMap((parentEntries + localEntries).associate { it.key to it.value })
    }

    override fun getVariablesLocal(): Map<String, Any?> = variablesLocalTyped

    override fun getVariablesLocalTyped(): OperatonVariableMap = getVariablesLocalTyped(true)

    override fun getVariablesLocalTyped(deserializeValues: Boolean): OperatonVariableMap {
        return OperatonVariableMap(getVariableInstancesLocal().associate {
