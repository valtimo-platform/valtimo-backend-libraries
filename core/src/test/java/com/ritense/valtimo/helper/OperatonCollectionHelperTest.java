...
class OperatonCollectionHelperTest {
    ...
    private OperatonCollectionHelper operatonCollectionHelper = new OperatonCollectionHelper();
    ...
    void shouldUpdateList() {
        operatonCollectionHelper.updateListElement(delegateTask, COLLECTION_NAME, ELEMENT_NAME);
    ...
    void shouldThrowExceptionWhenCollectionDoesntExist() {
        assertThrows(NullPointerException.class, () -> operatonCollectionHelper.updateListElement(delegateTask, "fake_collection_key", ELEMENT_NAME));
    }

    @Test
    void shouldThrowExceptionWhenElementDoesntExist() {
        assertThrows(NullPointerException.class, () -> operatonCollectionHelper.updateListElement(delegateTask, COLLECTION_NAME, "fake_element_key"));
    }

    @Test
    void shouldthrowExceptionWhenLoopcounterDoesntExist() {
        variableMap.remove(LOOP_COUNTER_NAME);
        assertThrows(NullPointerException.class, () -> operatonCollectionHelper.updateListElement(delegateTask, COLLECTION_NAME, ELEMENT_NAME));
    }
}