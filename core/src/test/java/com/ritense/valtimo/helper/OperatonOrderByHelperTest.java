...
class OperatonOrderByHelperTest {
    ...
    void testSortToOrdersHappyPathWithOneProperty() {
        ...
        List<QueryOrderingProperty> queryOrderingProperties = OperatonOrderByHelper
    ...
    @Test
    void testSortToOrdersWithInvalidOperatonEntityName() {
        assertThrows(IllegalArgumentException.class, () -> {
            OperatonOrderByHelper
    ...
    void testSortToOrdersWithSortPropertyContainingDisallowedCharacters() {
        assertThrows(IllegalArgumentException.class, () -> {
            OperatonOrderByHelper.sortToOrders("HistoricProcessInstance", invalidSortAscendingForHistoricProcessInstance);
        });
    }
    ...
    void testSortToOrdersWithUnrecognizedSortProperty() {
        assertThrows(IllegalArgumentException.class, () -> {
            OperatonOrderByHelper.sortToOrders("HistoricProcessInstance", invalidSortDescendingForHistoricProcessInstance);
        });
    }
    ...
    void testOrderByHappyPathWithContainedProperty() {
        List<QueryOrderingProperty> queryOrderingProperties = OperatonOrderByHelper
            .sortToOrders("HistoricProcessInstance", validSortAscendingForHistoricProcessInstance);
        String orderBy = OperatonOrderByHelper.orderBy(queryOrderingProperties.get(0), "tableAlias");
