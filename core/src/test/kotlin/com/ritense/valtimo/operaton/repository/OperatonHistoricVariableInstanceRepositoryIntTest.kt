...
class OperatonHistoricVariableInstanceRepositoryIntTest @Autowired constructor(
    private val operatonHistoricVariableInstanceRepository: OperatonHistoricVariableInstanceRepository
): BaseIntegrationTest() {

    @Test
    @Transactional
    fun `should find operaton historic variable instance`() {
