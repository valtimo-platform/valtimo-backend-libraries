...
class OperatonVariableInstanceSpecificationHelperIntTest @Autowired constructor(
    ...
    fun byName() {
        ...
        val result = operatonVariableInstanceRepository.findOne(
            OperatonVariableInstanceSpecificationHelper.byName(name)
        ).get()
    ...
    fun byNameIn() {
        ...
        val resultIds = operatonVariableInstanceRepository.findAll(
            OperatonVariableInstanceSpecificationHelper.byNameIn(*names)
        ).map { it.id }
    ...
    fun byProcessInstanceId() {
        ...
        val resultIds = operatonVariableInstanceRepository.findAll(
            OperatonVariableInstanceSpecificationHelper.byProcessInstanceId(processInstanceId)
        ).map { it.id }
    ...
    fun byProcessInstanceIdIn() {
        ...
        val resultIds = operatonVariableInstanceRepository.findAll(
            OperatonVariableInstanceSpecificationHelper.byProcessInstanceIdIn(*processInstanceIds)
        ).map { it.id }
