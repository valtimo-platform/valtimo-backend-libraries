...
class OperatonHistoricProcessInstanceRepositoryIntTest @Autowired constructor(
    private val operatonHistoricProcessInstanceRepository: OperatonHistoricProcessInstanceRepository
): BaseIntegrationTest() {

    @Test
    @Transactional
    fun `should find operaton a historic process instance`() {
        ...
        val result = operatonHistoricProcessInstanceRepository.findById(instance.id)
