...
class OperatonProcessDefinitionImporterIntTest @Autowired constructor(
    private val operatonProcessDefinitionImporter: OperatonProcessDefinitionImporter,
    ...
    fun `should import process definition with bpmn extension`() {
        ...
        runWithoutAuthorization {
            operatonProcessDefinitionImporter.import(request)
        }
