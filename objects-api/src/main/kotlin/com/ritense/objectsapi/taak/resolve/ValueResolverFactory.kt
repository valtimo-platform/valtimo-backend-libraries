...
interface ValueResolverFactory {
    ...
    /**
     * Returns the placeholder prefix that the resolver can handle.
     * For example, to resolve 'pv:someProperty', this method should return 'pv'
     *
     * @return The placeholder prefix (for example: 'pv')
     */
    fun supportedPrefix(): String

    /**
     * This creates a placeholder resolver within a certain context.
     * The returned resolver can be called multiple times within the same context for different placeholders.
     *
     * We can use this strategy to limit the amount of calls to an external source, which is a performance benefit.
     *
     * The placeholder argument of the returned resolver is already stripped of the prefix:
     * 'someProperty' will be passed as an argument when the original placeholder was 'pv:someProperty'
     *
     ...
     *
     * @return a resolver that handles one placeholder at a time within the same context.
     */
