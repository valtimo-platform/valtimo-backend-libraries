...
internal class FormFlowStepCompletedIntTest : BaseIntegrationTest() {
    ...
    fun `should send outbox event when completing formflow step`() {
        ...
        val formFlowInstance = startFormFlow("loan", caseDefinitionId)
        ...
        assertThat(event.get().type).isEqualTo("com.ritense.formflow.step.completed")
        assertThat(event.get().resultType).isEqualTo("com.ritense.formflow.event.FormFlowStepCompletedResult")
