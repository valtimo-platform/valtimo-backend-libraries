...
class ExpressionOperatorTest {

    @Test
    fun `NOT_EQUAL_TO should evaluate correctly`() {
        val op = ExpressionOperator.NOT_EQUAL_TO
    ...
    fun `EQUAL_TO should evaluate correctly`() {
        val op = ExpressionOperator.EQUAL_TO
    ...
    fun `GREATER_THAN should evaluate correctly`() {
        val op = ExpressionOperator.GREATER_THAN
    ...
    fun `GREATER_THAN_OR_EQUAL_TO should evaluate correctly`() {
        val op = ExpressionOperator.GREATER_THAN_OR_EQUAL_TO
    ...
    fun `LESS_THAN should evaluate correctly`() {
        val op = ExpressionOperator.LESS_THAN
    ...
    fun `LESS_THAN_OR_EQUAL_TO should evaluate correctly`() {
        val op = ExpressionOperator.LESS_THAN_OR_EQUAL_TO
    ...
    fun `CONTAINS should evaluate correctly`() {
        val op = ExpressionOperator.LIST_CONTAINS
    ...
    private fun assertEquals(expected: Boolean, op: ExpressionOperator, left: Any?, right: Any?) {
        kotlin.test.assertEquals(expected, op.evaluate(left, right), "[ $left ${op.asText} $right ]")
    }
}