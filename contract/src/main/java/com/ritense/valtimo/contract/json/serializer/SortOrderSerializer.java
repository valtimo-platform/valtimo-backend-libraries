...
public class SortOrderSerializer extends JsonSerializer<Sort.Order> {

    @Override
    public void serialize(Sort.Order order, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws
        IOException {
