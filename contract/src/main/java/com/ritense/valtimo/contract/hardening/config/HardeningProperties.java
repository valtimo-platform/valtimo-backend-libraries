...
public class HardeningProperties {
    ...
    public Set<String> getAllowStacktraceOnIps() {
        return allowStacktraceOnIps;
    }

    public void setAllowStacktraceOnIps(Set<String> allowStacktraceOnIps) {
        this.allowStacktraceOnIps = allowStacktraceOnIps;
    }
}
