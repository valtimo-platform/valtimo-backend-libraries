...
class PluginProcessLinkResource(
    ...
    ): ResponseEntity<List<CompatiblePluginProcessLinks>> {
        val compatiblePluginProcessLinks = pluginProcessLinkService.getCompatibleProcessLinks(pluginActionDefinitionKey)

        return ResponseEntity.ok(compatiblePluginProcessLinks)
    }
}
