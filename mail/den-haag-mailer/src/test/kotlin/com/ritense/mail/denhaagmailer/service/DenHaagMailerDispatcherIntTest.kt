...
internal class DenHaagMailerDispatcherIntTest : BaseIntegrationTest() {

    @Inject
    lateinit var denHaagMailerMailDispatcher: DenHaagMailDispatcher

    @Test
    fun `should instantiate DenHaagMailerDispatcher bean`() {
        assertThat(denHaagMailerMailDispatcher).isNotNull
    }
