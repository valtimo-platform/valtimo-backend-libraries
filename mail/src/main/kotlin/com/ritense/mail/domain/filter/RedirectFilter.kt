...
class RedirectToFilter(
    ...
    override fun doFilter(rawMailMessage: RawMailMessage): Optional<RawMailMessage> {
        rawMailMessage.recipients.filterBy { recipient: Recipient -> mailingProperties.sendRedirectedMailsTo.contains(recipient) }
    ...
    override fun doFilter(templatedMailMessage: TemplatedMailMessage): Optional<TemplatedMailMessage> {
        templatedMailMessage.recipients.filterBy { recipient: Recipient -> mailingProperties.sendRedirectedMailsTo.contains(recipient) }
