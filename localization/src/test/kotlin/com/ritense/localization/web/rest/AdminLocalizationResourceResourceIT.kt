...
import com.ritense.dashboard.domain.LocalizationResource
import com.ritense.dashboard.domain.WidgetConfiguration
import com.ritense.dashboard.repository.LocalizationRepository
...
class AdminLocalizationResourceResourceIT : BaseIntegrationTest() {
    ...
    @Autowired
    lateinit var dashboardRepository: LocalizationRepository
    ...
    private fun createWidgetConfiguration(dashboard: LocalizationResource): WidgetConfiguration {
