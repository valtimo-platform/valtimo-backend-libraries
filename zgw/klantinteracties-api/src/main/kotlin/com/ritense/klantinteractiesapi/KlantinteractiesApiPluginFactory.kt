...
class KlantinteractiesApiPluginFactory(
    pluginService: PluginService,
    private val klantinteractiesApiClient: KlantinteractiesApiClient,
) : PluginFactory<KlantinteractiesApiPlugin>(pluginService) {
    override fun create(): KlantinteractiesApiPlugin {
        return KlantinteractiesApiPlugin(
