...
public class BpmnElementAngularStateUrlLink extends CamundaBpmnElement implements FormLink {

    private String url;

    @JsonCreator
    public BpmnElementAngularStateUrlLink(String id, String url, Boolean isPublic) {
        super(id, isPublic);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BpmnElementAngularStateUrlLink)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        ...
        BpmnElementAngularStateUrlLink that = (BpmnElementAngularStateUrlLink) o;
