...
public class FormIoFormDefinitionResource implements FormDefinitionResource {
    ...
    public FormIoFormDefinitionResource(FormDefinitionService formDefinitionService) {
        this.formDefinitionService = formDefinitionService;
    }

    @Override
    public ResponseEntity<List<FormOption>> getAll() {
        return ResponseEntity.ok(formDefinitionService.getAllFormOptions());
    }
